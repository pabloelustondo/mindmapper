...
const nodes = [
    { id: 0, reflexive: false, text:'Hello' },
    { id: 1, reflexive: true, text:'Idea' },
    { id: 2, reflexive: false, text: 'Bad Idea'}
];
let lastNodeId = 2;
const links = [
...
function mousedown() {
    ...
    const node = { id: ++lastNodeId, reflexive: false, x: point[0], y: point[1], text:"new idea" };
    nodes.push(node);
